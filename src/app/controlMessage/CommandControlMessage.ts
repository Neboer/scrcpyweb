...
export class CommandControlMessage extends ControlMessage {
    ...
    public static Commands: Map<number, string> = new Map([
        [ControlMessage.TYPE_EXPAND_NOTIFICATION_PANEL, '展开通知面板'],
        [ControlMessage.TYPE_EXPAND_SETTINGS_PANEL, '展开设置面板'],
        [ControlMessage.TYPE_COLLAPSE_PANELS, '折叠面板'],
        [ControlMessage.TYPE_GET_CLIPBOARD, '获取剪贴板'],
        [ControlMessage.TYPE_SET_CLIPBOARD, '写入剪贴板'],
